...
public class FacturaDetalle {
	 ...
	 */
	@Id
	@SequenceGenerator(allocationSize = 1, name = "TCFACTURADETALLE_SDID_GENERATOR", sequenceName = "SEQ_TCFACTURADETALLE")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TCFACTURADETALLE_SDID_GENERATOR")
	@Column(name = "SFID")
	public Long getId() {
		return id;
	}
	...
	public String toString() {
		return "FacturaDetalle [id=" + id + ", factura_id=" + factura_id + ", comic_id=" + comic_id + ", cantidad="
